...
function App() {
  ...
  const agregarPelicula = async (pelicula) => {
    try {
      const response = await axios.get('https://my-json-server.typicode.com/FraNkoRasia/fake-json/peliculas');
      ...
      await axios.post('https://my-json-server.typicode.com/FraNkoRasia/fake-json/peliculas', pelicula);
  ...
  const borrarPelicula = async (id) => {
    try {
      await axios.delete(`https://my-json-server.typicode.com/FraNkoRasia/fake-json/peliculas/${id}`);
  ...
  const editarPelicula = async (pelicula) => {
    try {
      const response = await axios.put(`https://my-json-server.typicode.com/FraNkoRasia/fake-json/peliculas/${pelicula.id}`, pelicula);
